...
<?php
   include 'conexao.php';
      if ($_POST['nome']!=null){
          $nome = $_POST['nome'];
          $sqlConsulta = "select * from nota10.usuarios where nome like  '%$nome%' ";          
     } else 
     {
          $sqlConsulta = "select * from nota10.usuarios";
     }
          ...
          print("<tr>");
          print("<td colspan='3'><a href='cadastrarUsuarioLogin.html'><button> Novo Usuario <img id='miniIcone' src='_imagens/incluir.png'></button></a></td>");
          print("<td colspan='9'> <form action='consultaUsuarioLogin.php' method='post'><input type='text' name='nome' size='65'  placeholder='Pesquise por dados do Usuário'><input type='submit' value='Consultar'></form></td>");
          print("</tr>");
          print("<tr>");
          print("<th> ID </th>");
          print("<th> NOME </th>");
