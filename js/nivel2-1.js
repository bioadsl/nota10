var myViewModel = function()
{
    ...
    this.valorA = ko.observable(Math.ceil((Math.random()*5)+4));
    this.valorB = ko.observable(Math.ceil((Math.random()*4)+1));
	
	/*funções*/
	
	 this.resetValues = function() {
		this.valorA( Math.ceil((Math.random()*5)+4));
		this.valorB( Math.ceil((Math.random()*4)+1));
		this.resposta(null);	
    };
