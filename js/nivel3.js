var myViewModel = function()
{
    ...
    this.valorA = ko.observable(Math.floor((Math.random()*5)+1));
    this.valorB = ko.observable(Math.floor((Math.random()*5)+1));
	
	/*funções*/
	
	 this.resetValues = function() {
		this.valorA( Math.floor((Math.random()*5)+1));
		this.valorB( Math.floor((Math.random()*5)+1));
		this.resposta(null);	
    };
